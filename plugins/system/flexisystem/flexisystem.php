...
CSS
	...
	public function onContentPrepareForm($form, $data)
	{
		...
		!Factory::getLanguage()->isRtl()
			? /* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseStyle('fc-flexi_form', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/css/flexi_form.css' : 'components/com_flexicontent/assets/css/flexi_form.min.css'), array('version' => FLEXI_VHASH))
			: /* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseStyle('fc-flexi_form_rtl', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/css/flexi_form_rtl.css' : 'components/com_flexicontent/assets/css/flexi_form_rtl.min.css'), array('version' => FLEXI_VHASH));

		!Factory::getLanguage()->isRtl()
			? /* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseStyle('fc-flexi_containers', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/css/flexi_containers.css' : 'components/com_flexicontent/assets/css/flexi_containers.min.css'), array('version' => FLEXI_VHASH))
			: /* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseStyle('fc-flexi_containers_rtl', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/css/flexi_containers_rtl.css' : 'components/com_flexicontent/assets/css/flexi_containers_rtl.min.css'), array('version' => FLEXI_VHASH));

		!Factory::getLanguage()->isRtl()
			? /* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseStyle('fc-flexi_shared', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/css/flexi_shared.css' : 'components/com_flexicontent/assets/css/flexi_shared.min.css'), array('version' => FLEXI_VHASH))
			: /* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseStyle('fc-flexi_shared_rtl', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/css/flexi_shared_rtl.css' : 'components/com_flexicontent/assets/css/flexi_shared_rtl.min.css'), array('version' => FLEXI_VHASH));

		// Fields common CSS
		/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseStyle('fc-flexi_form_fields', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/css/flexi_form_fields.css' : 'components/com_flexicontent/assets/css/flexi_form_fields.min.css'), array('version' => FLEXI_VHASH));
		...
		/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-admin', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/js/admin.js' : 'components/com_flexicontent/assets/js/admin.min.js'), array('version' => FLEXI_VHASH));
		/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-validate', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/js/validate.js' : 'components/com_flexicontent/assets/js/validate.min.js'), array('version' => FLEXI_VHASH));

		// Add js function for custom code used by FLEXIcontent item form
		/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-itemscreen', Uri::root().(JDEBUG ? 'components/com_flexicontent/assets/js/itemscreen.js' : 'components/com_flexicontent/assets/js/itemscreen.min.js'), array('version' => FLEXI_VHASH));
