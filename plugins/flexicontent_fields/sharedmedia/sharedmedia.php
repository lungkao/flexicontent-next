...
class plgFlexicontent_fieldsSharedmedia extends FCField
{
	...
	public function onDisplayField(&$field, &$item)
	{
		...
		if ( $js_added === null )
		{
			...
			/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-form', \Joomla\CMS\Uri\Uri::root() . (JDEBUG ? 'plugins/flexicontent_fields/sharedmedia/js/form.js' : 'plugins/flexicontent_fields/sharedmedia/js/form.min.js'), array('version' => FLEXI_VHASH));
		}
	...
	public function onDisplayFieldValue(&$field, $item, $values = null, $prop = 'display')
	{
		...
		if ($js_added === null)
		{
			...
			/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-view', \Joomla\CMS\Uri\Uri::root() . (JDEBUG ? 'plugins/flexicontent_fields/sharedmedia/js/view.js' : 'plugins/flexicontent_fields/sharedmedia/js/view.min.js'), array('version' => FLEXI_VHASH));
		}
