	...
	public function onDisplayField(&$field, &$item)
	{
	  ...
	  if ($inputmask && !$inputmask_added)
		...
		if ($useimage && !$mm_mode_common_js_added)
		{
			...
			/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-form', \Joomla\CMS\Uri\Uri::root() . (JDEBUG ? 'plugins/flexicontent_fields/weblink/js/form.js' : 'plugins/flexicontent_fields/weblink/js/form.min.js'), array('version' => FLEXI_VHASH));
